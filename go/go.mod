module github.com/pzsp-teams/lib-python

go 1.25.5

require github.com/pzsp-teams/lib v0.0.0-20251208073120-ca1606f2b27d
...
require (
	...
	github.com/microsoftgraph/msgraph-sdk-go v1.90.0 // indirect
